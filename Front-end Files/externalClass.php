...
<!-- Everything inside the BODY tags are visible on page.-->
  <body>
    ...
    <h1 style="text-align: center">External Offense Codes and Descriptions</h1>
    <h3 style="text-align: center">Lists the external crime codes and their corresponding descriptions</h3>
        ...
        if ($result && $prepared_stmt->rowCount() > 0) { ?>
            ...
            <table class="table">
              <thead class="thead-dark">
                <tr>
                  <th scope="col">Offense Key Code</th>
                  <th scope="col">External Offense Description</th>
                </tr>
              </thead>
              <tbody>
