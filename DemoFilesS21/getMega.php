...
<!-- Everything inside the BODY tags are visible on page.-->
  <body>
    ...
    <h3 style="text-align: center">This table lists the 100 most recent reported crimes</h3>
    ...
    <?php
        ...
        if ($result && $prepared_stmt->rowCount() > 0) { ?>
            ...
            <table class="table" style="padding-bottom: 25px;">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th scope="col">Crime Completion</th>
