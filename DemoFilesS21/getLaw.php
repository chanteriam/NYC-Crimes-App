...
<!-- Any thing inside the HEAD tags are not visible on page.-->
  <head>
    ...
    <script>
  $( function() {
    var availableTags  = ["MISDEMEANOR", "FELONY", "VIOLATION"];
  ...
  <?php
      if (isset($_POST['field_submit'])) {
        ...
        <?php } else { ?>
          ...
          <h3 style="text-align: center">Sorry, no results found for law classification:  <?php echo $_POST['offense_input']; ?>. </h3>
        <?php }
    } ?>
