...
<h1 style="text-align: center"> Complaint Update Form </h1>
<h3 style="text-align: center"> Please use this form to update complaint information</h3>
      <div class="container">
        <form method="post">
    ...
    <?php
      if (isset($_POST['f_submit'])) {
        if ($result) { 
    ?>
          <h3 style ="text-align: center"> Complaint updated successfully. </h3>
    <?php 
        } else { 
    ?>
