    ...
    <?php
      if (isset($_POST['field_submit'])) {
        ...
        if ($result && $prepared_stmt->rowCount() > 0) { ?>
          <h4 style="text-align: center"> Offense Date Time Information</h4>
           <table class="table">
              <thead class="thead-dark">
                <tr>
                  <th scope="col">Complaint Number</th>
                  <th scope="col">Complaint Start Date</th>
                  <th scope="col">Complaint End Date</th>
                  <th scope="col">Complaint Start Time</th>
                  <th scope="col">Complaint End Time</th>
              ...
              <tbody>    
                  <?php foreach ($result as $row) { ?>
                    <tr>
                      ...
                      <td><?php echo $row["cmplnt_to_dt"]; ?></td>
                      <td><?php echo $row["cmplnt_fr_tm"]; ?></td>
                      <td><?php echo $row["cmplnt_to_tm"]; ?></td>
                      <td><?php echo $row["rpt_dt"]; ?></td>
            ...
            <h4 style="text-align: center"> Offense Type Information</h4>
            <table class="table">
              <thead class="thead-dark">
                <tr>
                  <th scope="col">External Offense Code</th>
                  <th scope="col">External Offense Desc.</th>
                  <th scope="col">Internal Offense Code</th>
                  <th scope="col">Internal Offense Desc.</th>
                  <th scope="col">Offense Completion</th>
            ...
            <h4 style="text-align: center"> Susptect and Victim Information</h4>
            <table class="table">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th scope="col">Victim Age Group</th>
                  <th scope="col">Victim Sex</th>
                  <th scope="col">Victim Race</th>
                </tr>
              </thead>
              <tbody>
                <?php foreach ($result as $row) { ?>
                    ...
                    <!-- End first row. Note this will repeat for each row in the $result variable-->
                    <!-- Print (echo) the value of mID in first column of table -->
                      <td><?php echo $row["vic_age_group"]; ?></td>
                      <!-- Print (echo) the value of title in second column of table -->
                      <td><?php echo $row["vic_sex"]; ?></td>
                      <!-- Print (echo) the value of movieYear in third column of table and so on... -->
                      <td><?php echo $row["vic_race"]; ?></td>
                    <!-- End first row. Note this will repeat for each row in the $result variable-->
                    </tr>
                  <?php } ?>
              </tbody>
